...
import { Spinner, Table, Row, Col, Form, InputGroup, Button } from 'react-bootstrap';
...
const BookList = () => {
    ...
    const onDelete = async (bid) => {
        if (!window.confirm(`${bid}번 도서를 삭재하시겠습니까?`)) return;
    ...
    return (
        <div className='my-5'>
            ...
            <Table>
                <thead>
                    <tr>
                        <th>ID</th><th>이미지</th><th>제목</th>
                        <th>저자</th><th>가격</th><th>등록일</th>
                        <th>삭제</th>
                    </tr>
                </thead>
                <tbody>
